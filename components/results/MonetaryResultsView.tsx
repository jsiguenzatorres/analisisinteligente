            ...
            >
                ...
                <div className="mt-6 px-2">
                    <div className="h-3 w-full bg-slate-100 rounded-full relative overflow-hidden">
                        <div className="absolute top-0 bottom-0 w-0.5 bg-slate-800 z-10" style={{ left: '80%' }}></div>
                        <div className={`h-full rounded-full transition-all duration-1000 ${isAcceptable ? 'bg-emerald-400' : 'bg-rose-500'}`} style={{ width: `${Math.min(100, (inference.projectedError / tolerableError) * 100) * 0.8}%` }}></div>
                    </div>
                ...
                <div className="space-y-6">
                    <div className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm relative overflow-hidden">
                        ...
                        <div className="h-6 w-full bg-slate-100 rounded-full relative overflow-hidden">
                            ...
                            <div className={`h-full rounded-full transition-all duration-1000 ${isAcceptable ? 'bg-gradient-to-r from-emerald-400 to-emerald-500' : 'bg-gradient-to-r from-rose-400 to-rose-600 error-stripe'}`} style={{ width: `${projectedPercent * 0.8}%` }}></div>
                        </div>
                        <div className="flex justify-between mt-2">
                            ...
                            <div className="text-center">
                                <span className="block text-[9px] font-black text-slate-300 uppercase">Error Tolerable</span>
